...
/// ];
///
/// let ans: Option<&str> = Selthi::new("What's your favorite programming language?", options).prompt();
///
/// match ans {
...
impl<'a> Selthi<'a> {
    ...
    /// Creates a [Selthi] with the provided message and options, along with default configuration values.
